...
for letter in text:
    index_counter += 1
    if letter == " " or letter == "." or letter == "\n" or letter == "," or letter == "?" or letter == "!" or letter == '"' or letter == "." or letter == "(" or letter == ")":
        isolated_word = text[word_starts_index: index_counter]
        if len(isolated_word) > 1:
            isolated_word = isolated_word[1:] + isolated_word[0] + "ay"
        else:
            if isolated_word.isalpha():
                isolated_word = isolated_word + "ay"

        translated_text += isolated_word + letter
        word_starts_index = index_counter + 1

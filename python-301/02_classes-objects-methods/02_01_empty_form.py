...
class PatientForm:
    def __init__(self, fname, lname, birthdate, gender, weight) -> None:
        self.fname = fname
        self.lname = lname
...
p1 = PatientForm("Jannis", "Gries", "21.02.1998", "male", "65")
p2 = PatientForm("Jannis", "Gries", "21.02.1998", "male", "65")
p3 = PatientForm("Jannis", "Gries", "21.02.1998", "male", "65")
